        ...
        <div className="small-background">
          <div className="bug-title">
            <p style={{ color: "#f0f0f0" }}>
              {bugDetails?.bugAttributes.title}
            </p>
          </div>
          <div className="row">
            <div className="col-md-4">
              <div className="form-group my-custom-label">
                ...
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.fixedRevision}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Severity:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.severity}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Target Date:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.targetDate}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Version:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.version}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Status:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.status}
                </label>
              </div>
            </div>
            <div className="col-md-4">
              <div className="form-group my-custom-label">
                ...
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.reporterUsername}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Assignee Username:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.assigneeUsername}
                </label>
              </div>
              <div className="form-group my-custom-label">
                <label style={{ color: "#f0f0f0" }}>Description:</label>
                <label style={{ color: "#f0f0f0" }}>
                  {bugDetails?.bugAttributes.description}
                </label>
              </div>
            </div>
            <div className="col">
            ...
            <div className="row">
              <div className="my-button-group">
                <button
                  type="button"
                  className="btn btn-primary btn-lg my-custom-button"
                >
